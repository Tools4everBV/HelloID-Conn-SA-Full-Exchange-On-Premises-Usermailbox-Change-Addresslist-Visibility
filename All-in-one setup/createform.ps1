...
<# Begin: DataSource "exchange-on-premises-usermailbox-change-addresslist-visibility | Exchange-On-Premises-Get-User-Wildcard-Name-Alias" #>
$tmpPsScript = @'
...
exchange-on-premises-usermailbox-change-addresslist-visibility | Exchange-On-Premises-Get-User-Wildcard-Name-Alias
'@ 
